...
$header[] = "X-Location: 3.574".mt_rand(100,999).",98.71".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.92495906".mt_rand(100,999).",107.63690091".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -8.655518375".mt_rand(100,999).",115.2251800149".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
